...
<form action="<?php echo base_url('case_details/jpj_process?account=' . $case->ind_akaun . '&case_type=jpj') ?>" method="post" enctype="multipart/form-data" > 
	<div class="form-group">
		<textarea name="content" id="jpj" cols="100" rows="10"><?php if ($jpj->num_rows() > 0): ?><?php echo $content = $jpj->row()->jpj_content?><?php endif ?></textarea>
	</div><!-- /.form-group -->
