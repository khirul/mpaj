<h3>Carian SSM/Pejabat Tanah/JPN/Insolvensi/Cukai Taksiran</h3>
<hr />

<form action="<?php echo base_url('case_details/ssm_process?account=' . $case->ind_akaun . '&case_type=ssm') ?>" method="post" enctype="multipart/form-data" > 
	<div class="form-group">
		<textarea name="content" id="ssm" cols="100" rows="10"><?php if ($ssm->num_rows() > 0): ?><?php echo $content = $ssm->row()->ssm_content?><?php endif ?></textarea>
	</div><!-- /.form-group -->
